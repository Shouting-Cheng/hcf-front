...
const chooserData = {
  ...
  budget_item_budget: {
    title: messages('chooser.data.budget_item'),
    url: `${config.budgetUrl}/api/budget/items/query`,
    searchForm: [{ type: 'input', id: 'itemCode', label: messages('chooser.data.code') }],
    columns: [
      { title: messages('chooser.data.code'), dataIndex: 'itemCode', width: '45%' },
      { title: messages('chooser.data.name'), dataIndex: 'itemName', width: '55%' },
    ],
  ...
  gl_select_dimension: {
    ...
    columns: [{ title: '维度代码', dataIndex: 'code' }, { title: '维度名称', dataIndex: 'name' }],
    key: 'id',
    listKey: 'records',
  },
  //核算工单行上公司
    ...
    searchForm: [
      {
        type: 'input',
        id: 'journalTypeCode',
        label: messages('budgetJournal.journalTypeId.code') /*'预算日记账类型代码'*/,
      },
      {
        type: 'input',
        id: 'journalTypeName',
        label: messages('budgetJournal.journalTypeId.name') /*'预算日记账类型名称'*/,
      },
    ],
    columns: [
      {
        title: messages('budgetJournal.journalTypeId.code') /*'预算日记账类型代码'*/,
        dataIndex: 'journalTypeCode',
      },
      {
        title: messages('budgetJournal.journalTypeId.name') /*'预算日记账类型名称'*/,
    ...
    searchForm: [
      {
        type: 'input',
        id: 'versionCode',
        label: messages('budgetVersion.versionCode') /*'预算版本代码'*/,
      },
      {
        type: 'input',
        id: 'versionName',
        label: messages('budgetVersion.versionName') /*'预算版本名称'*/,
      },
    ],
    columns: [
    ...
    searchForm: [
      {
        type: 'input',
        id: 'scenarioCode',
        label: messages('budget.scenarios.code') /*'预算场景代码'*/,
      },
      {
        type: 'input',
        id: 'scenarioName',
        label: messages('budget.scenarios.name') /*'预算场景名称'*/,
      },
    ],
    columns: [
    ...
    searchForm: [
      {
        type: 'input',
        id: 'deptGroupCode',
        label: messages('chooser.data.code'),
        defaultValue: '',
      },
      {
        type: 'input',
        id: 'description',
        label: messages('chooser.data.description'),
        defaultValue: '',
      },
    ],
    columns: [
    ...
    searchForm: [
      {
        type: 'input',
        id: 'name',
        label: `${messages('chooser.data.costCenter.name')}/${messages(
          'cost.center.detail.manager'
        )}/${messages('chooser.data.costCenter.code')}`,
      },
    ],
    columns: [
      {
    ...
    searchForm: [
      {
        ...
        label: `${messages('chooser.data.costCenter.name')}/${messages(
          'cost.center.detail.manager'
        )}/${messages('cost.center.detail.no')}`,
      },
    ],
    columns: [
      {
    ...
    searchForm: [
      {
        ...
        label: messages('chooser.data.costCenter.name'),
        defaultValue: '',
      },
    ],
    columns: [
    ...
    searchForm: [
      {
        type: 'input',
        id: 'departmentCode',
        label: messages('chooser.data.dep.num'),
        defaultValue: '',
      },
    ...
    searchForm: [
      {
        type: 'input',
        id: 'setOfBookId',
        label: messages('chooser.data.setOfBooks'),
        defaultValue: '',
      },
      { type: 'input', id: 'classCode', label: messages('chooser.data.transaction.code') },
      {
        type: 'input',
        id: 'description',
        label: messages('chooser.data.cash.flow.item.description'),
      },
    ],
    columns: [
    ...
    searchForm: [
      {
        type: 'input',
        id: 'itemCode',
        label: messages('budget.itemCode') /*"预算项目代码",*/,
        defaultValue: '',
      },
      {
        type: 'input',
        id: 'itemName',
        label: messages('budget.itemName') /*"预算项目名称"*/,
        defaultValue: '',
      },
    ],
    columns: [
  ...
  budget_structure: {
    ...
    searchForm: [
      ...
      },
      {
        type: 'input',
        id: 'structureName',
        label: messages('chooser.data.name'),
        defaultValue: '',
      },
    ],
    columns: [
  ...
  year: {
    ...
    searchForm: [],
    columns: [{ title: messages('chooser.data.year'), dataIndex: 'year' }],
    key: 'year',
    isValue: true,
  },
  period: {
    ...
    columns: [{ title: messages('chooser.data.period'), dataIndex: 'periodName' }],
    key: 'id',
  },
  quarter: {
    ...
    columns: [{ title: messages('chooser.data.quarter'), dataIndex: 'messageKey' }],
    key: 'id',
  },
  ...
  contract_type: {
    ...
    searchForm: [
      ...
      { type: 'input', id: 'contractTypeName', label: messages('chooser.data.name') },
      {
        type: 'value_list',
        id: 'contractCategory',
        label: messages('chooser.data.contract.category'),
        options: [],
        valueListCode: 2202,
      },
    ],
    ...
    searchForm: [
      {
        type: 'input',
        id: 'formType',
        label: messages('chooser.data.form.type'),
        defaultValue: 107,
      },
  ...
  allotSetOfBookCompany: {
    ...
    searchForm: [
      { type: 'input', id: 'name', label: messages('chooser.data.companyName' /*公司名称*/) },
      {
        type: 'input',
        id: 'companyCode',
        label: messages('chooser.data.companyCode' /*公司编码*/),
      },
    ],
    columns: [
      { title: messages('chooser.data.companyName' /*公司名称*/), dataIndex: 'name' },
  ...
  selectInvoiceType: {
    ...
    searchForm: [{ type: 'input', id: 'name', label: messages('itemMap.expenseTypeName') }],
    columns: [
      {
        title: messages('itemMap.icon'),
        dataIndex: 'iconURL',
        render: value => {
    ...
    searchForm: [
      {
        type: 'input',
        id: 'input',
        label: `${messages('chooser.data.code')}/${messages('chooser.data.name')}`,
      },
    ],
    columns: [
      ...
      {
        title: messages('chooser.data.accounting.elements.property.code'),
        dataIndex: 'mappingGroupCode',
      },
      {
        title: messages('chooser.data.accounting.elements.property.name'),
  ...
  'data-source-fields_dataRules': {
    title: messages('accounting.source.sourceDatafile'),
    url: `${config.accountingUrl}/api/accounting/util/general/ledger/fields/data/source/fields`,
    searchForm: [
      { type: 'input', id: 'code', label: messages('chooser.data.code') },
      { type: 'input', id: 'description', label: messages('chooser.data.name') },
  ...
  participants: {
    ...
    columns: [
      ...
      {
        title: messages('chooser.data.dep'),
        dataIndex: 'departmentName',
        render: value => value || '-',
      },
  ...
  corporation_entity_all: {
    ...
    columns: [
      {
        title: messages('chooser.data.legal.entity.name'),
  ...
  booker: {
    ...
    searchForm: [{ type: 'input', id: 'name', label: messages('chooser.data.fullName') }],
    columns: [
      { title: messages('chooser.data.fullName'), dataIndex: 'fullName' },
      { title: messages('chooser.data.employeeID'), dataIndex: 'employeeID' },
      {
  ...
  my_request: {
    ...
    searchForm: [{ type: 'input', id: 'keyword', label: messages('common.matter') /*事由*/ }],
    columns: [
      {
        title: messages('my.contract.create.date') /*创建时间*/,
      ...
      {
        title: messages('chooser.data.my.relevantMemeber') /*'相关人员'*/,
  ...
  payment_type: {
    ...
    columns: [
      ...
      {
        title: messages('payment.batch.company.payCode') /*'付款代码'*/,
  ...
  'batch-allot-company': {
    ...
    searchForm: [
      ...
      },
      {
        type: 'input',
        id: 'companyCode',
        label: messages('value.list.company.code') /*"公司代码"*/,
      },
      { type: 'input', id: 'name', label: messages('value.list.company.name') /*"公司名称"*/ },
      {
        type: 'input',
        id: 'companyCodeFrom',
        label: messages('structure.companyCodeFrom') /*"公司代码从"*/,
      },
      {
        type: 'input',
        id: 'companyCodeTo',
        label: messages('structure.companyCodeTo') /*"公司代码至"*/,
      },
    ],
    columns: [
      {
  ...
  'add-cost-center-group': {
    ...
    searchForm: [
      ...
      {
        type: 'input',
        id: 'costCenterItemCodeStart',
        label: messages('cost.center.group.code.from') /*"成本中心项代码从"*/,
      },
      {
        type: 'input',
        id: 'costCenterItemCodeEnd',
        label: messages('cost.center.group.code.to') /*"成本中心项代码至"*/,
      },
      {
        type: 'input',
        id: 'costCenterItemNameOrCode',
        label: messages('cost.center.group.item.code.name') /*"成本中心名称/代码"*/,
      },
    ],
    columns: [
      {
    ...
    searchForm: [
      {
        type: 'select',
        id: 'setOfBooksId',
        label: messages('supplier.company.setOfBook'),
        options: [],
    ...
    searchForm: [
      {
        ...
        id: 'fullName',
        label: messages(
          'bookingManagement.bookingDetails.maintain.chooser.tips'
        ) /*"乘机人姓名，部门，职位"*/,
      },
    ],
    columns: [
      {
        title: messages('bookingManagement.bookingDetails.maintain.chooser.avatar') /*"头像"*/,
        dataIndex: 'avatar',
        render: value => <Avatar src={value} />,
        width: '10%',
      },
      {
        title: messages('bookingManagement.bookingDetails.maintain.chooser.name') /*"姓名"*/,
        dataIndex: 'fullName',
      },
      {
        title: messages('bookingManagement.bookingDetails.maintain.chooser.dep') /*"部门"*/,
        dataIndex: 'departmentName',
      },
      {
        title: messages('bookingManagement.bookingDetails.maintain.chooser.title') /*"职位"*/,
        dataIndex: 'title',
      },
    ],
    key: 'userOid',
