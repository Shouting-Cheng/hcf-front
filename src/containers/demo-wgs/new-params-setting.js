    ...
    let data = Object.assign({},params,values);
      ...
      this.setState({
       ...
       if(!params.id){
        ...
        service.editParamsSetting(data).then(res => {
      ...
      <div>
        ...
        <FormItem
          ...
          <div className="footer-button">
            <Button className="btn" type="primary" htmlType="submit" loading={saveLoading}> {this.$t('common.save')}</Button>
            <Button className="btn" onClick={this.handleCancel}>{this.$t('common.cancel')}</Button>
          </div>
