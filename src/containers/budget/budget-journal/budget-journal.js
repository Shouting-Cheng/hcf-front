  ...
  constructor(props) {
    ...
    this.state = {
      ...
      searchForm: [
        ...
        {
          type: 'input', id: 'journalCode', label: formatMessage({ id: 'budgetJournal.journalCode' }), /*预算日记账编号*/
        },
        { type: 'value_list', label: formatMessage({ id: "budgetJournal.periodStrategy" }), id: 'periodStrategy', options: [], valueListCode: 2002 },
        { type: 'value_list', label: formatMessage({ id: "budgetJournal.status" }), id: 'status', options: [], valueListCode: 2028 },
      ],
      ...
      columns: [
        ...
        {          /*预算日记账类型*/
          title: formatMessage({ id: "budgetJournal.journalTypeId" }), key: "journalTypeName", dataIndex: 'journalTypeName', width: '16%',
          render: recode => (
            <Popover content={recode}>
              {recode}
            </Popover>)
        ...
        {          /*编制期段*/
          title: formatMessage({ id: "budgetJournal.periodStrategy" }), key: "periodStrategyName", dataIndex: 'periodStrategyName', width: '8%'
        },
        {          /*预算表*/
        ...
        {          /*状态*/
          ...
          render(recode, text) {
            switch (recode) {
              ...
              case 5003: { return <Badge status="default" text='反冲复核' /> }
            }
          }
        },
      ],
...
export default connect(mapStateToProps, null, null, { withRef: true })((BudgetJournal));
