...
class NewBudgetJournalFrom extends React.Component {
      ...
      defaultDataList: [
        {
          type: 'chooser',
          event: 'versionName',
          defaultValueKey: 'versionName',
          url: `${
            config.budgetUrl
          }/api/budget/versions/query?enabled=true&status=CURRENT&organizationId=${
        ...
        },
        {
          type: 'chooser',
          event: 'scenarioName',
          defaultValueKey: 'scenarioName',
          url: `${config.budgetUrl}/api/budget/scenarios/query?defaultFlag=true&organizationId=${
            this.props.organization.id
          }`,
        },
      ],
      ...
      httpFetch
        ...
        .then(response => {
          if (item.type === 'chooser') {
            ...
            this.props.form.setFieldsValue(defaultValueList);
          }
        })
        .catch(e => {
  ...
  saveHeard = value => {
    ...
    budgetJournalService
      .addBudgetJournalHeaderLine(value)
      .then(response => {
  ...
  getStructure(value) {
    ...
    budgetJournalService
      ...
      .then(res => {
        ...
        budgetJournalService
          .getDefaultStructure(queryDefaultStructureParams)
          .then(response => {
            if (response.data) {
              res.data.map(item => {
                item.key = item.id;
  ...
  render() {
    ...
    const strategyOptions = structureGroup.map(item => (
      <Option value={String(item.id)}>{item.structureName}</Option>
    ));
    const periodStrategyOptions = periodStrategy.map(item => (
    ...
    return (
      <div className="new-budget-journal">
        <div className="budget-journal-title">
          <div>
            <h1>{this.$t({ id: 'budgetJournal.journal' })}</h1>
          </div>
          <div className="budgetJournal-journal-title-detail">
            {this.$t({ id: 'budgetJournal.journalDetail' })}
          </div>
        </div>
        <div className="divider"> </div>
        <Form onSubmit={this.handleFrom} style={{}}>
          <Card title={this.$t({ id: 'budgetJournal.basicInformation' })} style={{ with: '100%' }}>
            <Row gutter={40} type="flex" align="top">
              <Col span={8}>
                <FormItem {...formItemLayout} label={this.$t({ id: 'budgetJournal.journalCode' })}>
              ...
              <Col span={8}>
                <FormItem {...formItemLayout} label={this.$t({ id: 'budgetJournal.employeeId' })}>
              ...
              <Col span={8}>
                <FormItem {...formItemLayout} label={this.$t({ id: 'budgetJournal.companyId' })}>
                  {getFieldDecorator('companyId', {
                    rules: [
                      {
                        required: true,
                        message:
                          'this.$t({id: "common.can.not.be.empty"}, {name:"journalTypeName"}',
                      },
                    ],
              ...
              <Col span={8}>
                <FormItem {...formItemLayout} label={this.$t({ id: 'budgetJournal.unitId' })}>
          ...
          <Card title={this.$t({ id: 'budgetJournal.budgetInformation' })} style={{ with: '100%' }}>
            <Row gutter={40} type="flex" align="top">
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                    ...
                    rules: [
                      {
                        required: true,
                        message: this.$t(
                          { id: 'common.can.not.be.empty' },
                          { name: this.$t({ id: 'budgetJournal.journalTypeId' }) }
                        ),
                      },
                    ],
                  })(
              ...
              <Col span={8}>
                <FormItem {...formItemLayout} label={this.$t({ id: 'budgetJournal.structureId' })}>
                    ...
                    rules: [
                      {
                        ...
                        message: this.$t(
                          { id: 'common.can.not.be.empty' },
                          { name: this.$t({ id: 'budgetJournal.structureId' }) }
                        ),
                      },
                    ],
                  })(
                    ...
                    rules: [
                      {
                        ...
                        message: this.$t(
                          { id: 'common.can.not.be.empty' },
                          { name: this.$t({ id: 'budgetJournal.periodStrategy' }) }
                        ),
                      },
                    ],
                  })(<Select disabled={periodStrategyFlag}>{periodStrategyOptions}</Select>)}
                </FormItem>
              </Col>
              <Col span={8}>
                <FormItem {...formItemLayout} label={this.$t({ id: 'budgetJournal.versionId' })}>
                    ...
                    rules: [
                      {
                        ...
                        message: this.$t(
                          { id: 'common.can.not.be.empty' },
                          { name: this.$t({ id: 'budgetJournal.version' }) }
                        ),
                      },
                    ],
                    valuePropName: 'value',
              ...
              <Col span={8}>
                <FormItem {...formItemLayout} label={this.$t({ id: 'budgetJournal.scenarios' })}>
                    ...
                    rules: [
                      {
                        ...
                        message: this.$t(
                          { id: 'common.can.not.be.empty' },
                          { name: this.$t({ id: 'budgetJournal.scenarios' }) }
                        ),
                      },
                    ],
          ...
          <Card
            title={this.$t({ id: 'budgetJournal.attachmentInformation' })}
            style={{ with: '100%' }}
          >
            <Row gutter={40} type="flex" align="top">
              <Col span={8}>
                <FormItem
                  {...formItemLayout}
                  label={this.$t({ id: 'budgetJournal.attachment' })} //附件
                >
          ...
          <div className="divider" style={{ height: 40 }}>
            {' '}
          </div>
          <Affix
            offsetBottom={0}
          ...
          >
            <Button
              ...
              style={{ margin: '0 20px' }}
            >
              {this.$t({ id: 'budgetJournal.lastStep' })}
            </Button>
            <Button onClick={this.HandleClear}>{this.$t({ id: 'budgetJournal.return' })}</Button>
          </Affix>
        </Form>
      </div>
    );
