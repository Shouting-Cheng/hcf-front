...
class BudgetBalanceResult extends React.Component {
  ...
  render(){
    const {
      columns, data, condition, loading, showSlideFrameFlag, slideFrameParam, pagination, dimensionColumns, showExporterFlag, scrollx
    } = this.state;
      ...
      <div className="budget-balance-result">
        ...
        <div className="footer-operate">
          <Button type="primary" onClick={() => {
            this.props.dispatch(
              routerRedux.replace({
                pathname: '/budget/budget-balance-query'
              })
            );
