...
import ListSelector from 'containers/budget/budget-balance-query/list-selector'
    ...
    return (
      <div className={showNumber ? 'chooser number-only' : 'chooser'}>
        ...
        <div className="chooser-number" onClick={() => { !this.props.disabled && this.showList() }}>
          {messages("common.total.selected" , { total: value.length })}
        </div>
