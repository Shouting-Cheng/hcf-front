...
class GLWorkOrderCheck extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            searchForm1:
                [
                    {
                        type: 'select', label: '单据类型', id: 'typeId', colSpan: '6',
                    ...
                    {
                        type: 'items', id: 'amount', colSpan: '6',
                        items:
                            [
                    ...
                    {
                        type: 'input', label: '备注', id: 'description', colSpan: '6'
                    }
                ],
            searchParams1: {},
            /**
            ...
            */
            ...
            columns1:
                [
                    {
                        title: '单据编号', dataIndex: 'businessCode', align: 'center', width: 180,
                    },
                    {
                    ...
                    {
                        title: '提交日期', dataIndex: 'submittedDate', align: 'center', width: 90,
                        render: (submittedDate, record, index) => {
                            return (
                                <span>{moment(submittedDate).format('YYYY-MM-DD')}</span>
                            )
                        }
                    },
                    {
                        title: '币种', dataIndex: 'currencyCode', align: 'center', width: 90,
                    },
                    {
                        title: '金额', dataIndex: 'totalAmount', align: 'center',
                        render: (totalAmount, record, index) => {
                            return (
                                <span>{this.filterMoney(totalAmount, 2)}</span>
                            )
                        }
                    },
                    {
    ...
    getList1 = () => {
        ...
        let params = {
            ...
            beginDate: searchParams1.beginDate ? moment(searchParams1.beginDate).format('YYYY-MM-DD') : '',
        ...
        glWorkOrderCheckService.getList(params).then(res => {
            if (res.status === 200) {
                this.setState({
                    loading1: false,
    ...
    getList2 = () => {
        ...
        let params = {
            ...
            beginDate: searchParams2.beginDate ? moment(searchParams2.beginDate).format('YYYY-MM-DD') : '',
...
export default connect(mapStateToProps, null, null, { withRef: true })(GLWorkOrderCheck);
