    ...
    constructor(props) {
        ...
        this.state = {
            ...
            columns: [
                ...
                {
                    title: '操作', dataIndex: 'contractHeaderId', align: 'center',
                    render: (value) => {
                        return (
    ...
    expandedRowRender = (record, index) => {
        const columns = [
            { title: '付款计划序号', dataIndex: 'lineNumber', key: 'lineNumber' },
            {
                ...
                render: (value, record) => {
                    return <span>{record.currency} {this.formatMoney(value)}</span>
                }
            },
            {
            ...
            <Modal
                ...
                <div className="table-header">
                    <div className="table-header-title">
                        ...
                        &nbsp;<span>/</span>&nbsp;
                        {this.$t("common.total.selected", { total: selectedData.length === 0 ? '0' : selectedData.length })}
                    </div>
                </div>
