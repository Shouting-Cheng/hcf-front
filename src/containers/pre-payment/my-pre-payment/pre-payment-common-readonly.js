...
import { Form, Icon, Tag, Tabs, Button, Row, Col, Spin, Breadcrumb, Table, Timeline, message, Popover, Popconfirm } from 'antd'
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      columns:
        [
          {
            title: '序号', dataIndex: 'index', align: "center", width: '6%',
            render: (value, record, index) => (index + 1)
          },
          {
            title: '预付款金额', dataIndex: 'amount', width: '13%',
            render: (value, record) => {
              return (
                <div>
          ...
          {
            title: '预付款类型', width: '12%', dataIndex: 'cshTransactionClassName', align: 'center'
          },
          {
            title: '收款对象', width: '10%', dataIndex: 'currency', align: 'center',
            render: (value, record) => {
              return (
                <div>
          ...
          {
            title: '收款账户', width: '22%', dataIndex: 'partnerId',
            render: (value, record) => {
              return (
                <div>
          ...
          {
            title: '付款属性', dataIndex: 'refDocumentCode', width: '22%',
            render: (value, record) => {
              return (
                <Popover content={
          ...
          {
            title: '备注', dataIndex: 'description', width: '15%', align: 'center',
            render: value => {
              return (
    ...
    return (
      <div className="pre-payment-common">
        ...
        <SlideFrame
          ...
          params={{ id: this.state.id, paymentReqTypeId: this.state.paymentReqTypeId, companyId: this.state.companyId, flag: this.state.flag, remark: this.state.headerData.description, record, headerData: this.state.headerData }}
