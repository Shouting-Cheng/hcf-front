          ...
          items: [
            {
              ...
              options: [
                {
                  label: messages('constants.documentStatus.all'),
  ...
  getForms = () => {
    ...
    expenseReportService.getDocumentType(102).then(res => {
      ...
      formCheckBoxItem.items = [
        { label: messages('common.document.name'), key: 'formOID', options, checked: ['all'] },
      ];
        ...
        <div className="table-header">
          ...
          <div className="table-header-buttons">
            <Dropdown overlay={menu}>
              <Button type="primary">
                {messages('expense-report.new') /*新建报销单*/} <Icon type="down" />
              </Button>
            </Dropdown>
            {/*代理制单*/}
            <Proxies />
