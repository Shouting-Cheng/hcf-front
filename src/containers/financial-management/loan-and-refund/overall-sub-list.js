...
class OverallSubList extends React.Component {
    ...
    this.state = {
      ...
      searchForm: [
        ...
        },
        {
          type: 'radio',
          id: 'repaymentStatus',
          label: messages('finance.loan.refund.borrow.status' /*借款状态*/),
          options: [
      ...
      columns: [
        ...
        {
          title: messages('finance.loan.refund.loan.date' /*借款日期*/),
        ...
        { title: messages('common.currency'), dataIndex: 'currencyCode', width: '10%' },
        {
          ...
          render: value => <span className="money-cell">{this.renderMoney(value)}</span>,
        },
        {
  ...
  getEmployeeLoanInfo = () => {
    loanAndRefundService
      .getLoanInfoByEmployeeId(this.props.params.employeeId, this.props.params.currencyCode)
      .then(res => {
  ...
  getList = () => {
    ...
    loanAndRefundService
      .getLoanListByEmployeeId(page, pageSize, this.props.params.employeeId, searchParams)
      .then(res => {
        this.setState({
          loading: false,
          data: res.data,
    ...
    return (
      <div className="overall-sub-list">
        <div className="employee-loan-info">
          <div>
            ...
            <span className="employee-info">
              {loanInfo.employeeId} - {loanInfo.departmentName} - {loanInfo.departmentPath}
            </span>
          </div>
          <div>
        ...
        <a onClick={this.handleBack}>
          <Icon type="rollback" className="back-icon" />
