...
class CshWriteOffBacklash extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            columns1: [
                ...
                {
                    title: '核销反冲日期',
                    dataIndex: 'writeOffDate', width: '98', align: 'center',
                    render: (writeOffDate) => {
                        return (
                            writeOffDate ? moment(writeOffDate).format('YYYY-MM-DD') : ''
                        )
                    }
                },
                {
                    title: '申请人',
                    dataIndex: 'documentApplicantName', width: '70', align: 'center'
                },
                {
                    title: '被核销单据编号',
                    dataIndex: 'sourceDocumentNumber', width: '154', align: 'center',
                    render: (sourceDocumentNumber, record, index) => {
                        return (
                            <Popover content={sourceDocumentNumber}>
                                <a onClick={(e) => this.onSourceDocumentNumberClick(e, record, index)}>{sourceDocumentNumber}</a>
                            </Popover>
                        )
                    }
                },
                {
                    title: '付款流水号',
                    dataIndex: 'billCode', width: '154', align: 'center',
                    render: (billCode) => {
                        return (
                ...
                {
                    title: '核销金额',
                    dataIndex: 'writeOffAmount', width: '130', align: 'center',
                ...
                {
                    title: '本次核销反冲金额',
                    dataIndex: 'reversedAmount', width: '160', align: 'center',
                    render: (reversedAmount, record, index) => {
                        return (
                            <div>
                                {record.cashWriteOffReverseHistory.length ?
                                    <Popover
                                        content={<Timeline>{record.cashWriteOffReverseHistory.map(item => {
                                            return <Timeline.Item key={item.id}>
                                                {moment(item.writeOffDate).format('YYYY-MM-DD HH:mm:ss')}
                                                &nbsp;&nbsp;{item.createdName}
                                                &nbsp;&nbsp;核销反冲
                                                &nbsp;{item.currency}{this.filterMoney(item.reversedAmount, 2, true)}
                                            </Timeline.Item>
                                        })}</Timeline>}
                                        trigger='hover'
                                        title='核销反冲历史'
                                    >
                                        {
                                            record.editReverseAmountVisible === true
                                                ...
                                                <Row>
                                                    ...
                                                    <Col span={4}>
                                                        &nbsp;<Icon onClick={(e) => this.onEditReverseAmountClick(e, record, index)} type='edit'></Icon>
                                                    </Col>
                                                </Row>
                                                :
                                                <Row>
                ...
                {
                    title: '备注',
                    dataIndex: 'remark', width: '150', align: 'center',
                            ...
                            <Popover content={remark}>
                                {
                                    record.editRemarkVisible === true
                                        ...
                                        <Row>
                                            <Col span={20}>
                                                <Input placeholder='请输入' defaultValue={remark} value={remark} onChange={(value) => this.onRemarkChange(value, record, index)} />
                                            </Col>
                                            <Col span={4}>
                                                &nbsp;<Icon onClick={(e) => this.onEditRemarkClick(e, record, index)} type='edit'></Icon>
                                            </Col>
                                        </Row>
                                        :
                                        <Row>
                ...
                {
                    title: '附件',
                    dataIndex: 'attachments', align: 'center',
                ...
                {
                    title: '操作',
                    dataIndex: 'operation', width: '112', fixed: 'right', align: 'center',
                    render: (operation, record, index) => {
                        return (
                            <Popconfirm title='是否确认发起此次核销反冲？' okText='确定' cancelText='取消' onConfirm={(e) => { this.onOperationClick(e, record, index) }}>
                                <a>发起核销反冲</a>
                            </Popconfirm>
                        )
                    }
            ...
            searchForm1: [
                ...
                { type: 'list', listExtraParams: { setOfBooksId: this.props.company.setOfBooksId }, colSpan: '6', id: 'applicantId', label: '申请人', listType: 'user_budget', valueKey: 'id', labelKey: 'fullName', single: true },
            ...
            columns2: [
                {
                    title: '报账单编号',
                    dataIndex: 'documentNumber', width: '144', align: 'center',
                    render: (documentNumber) => {
                        return (
                            <Popover content={documentNumber}>
                                <span>{documentNumber}</span>
                ...
                {
                    title: '核销反冲日期',
                    dataIndex: 'writeOffDate', width: '120', align: 'center',
                    render: (writeOffDate) => {
                ...
                {
                    title: '申请人',
                    dataIndex: 'documentApplicantName', align: 'center', width: '70'
                },
                {
                    title: '被核销单据编号',
                    dataIndex: 'sourceDocumentNumber', width: '144', align: 'center',
                ...
                {
                    title: '付款流水号',
                    dataIndex: 'billCode', width: '144', align: 'center',
                    render: (billCode) => {
                        return (
                            <Popover content={billCode}>
                                <span>{billCode}</span>
                ...
                {
                    title: '核销金额',
                    dataIndex: 'writeOffAmount', width: '150', align: 'center',
                    render: (writeOffAmount, record, index) => {
                        return (
                            <div><span>{record.currency}&nbsp;{this.filterMoney(writeOffAmount, 2, true)}</span></div>
                        )
                    }
                },
                {
                                ...
                                (
                                    record.editReverseAmountVisibleWait === true
                                        ...
                                        <Row>
                                            ...
                                            <Col span={4}>
                                                &nbsp;<Icon onClick={(e) => this.onEditReverseAmountWaitClick(e, record, index)} type='edit'></Icon>
                                            </Col>
                                        </Row>
                                        :
                                        < Row >
                                ...
                                <Popover content={remark}>
                                    {
                                        record.editRemarkVisibleWait === true
                                            ...
                                            <Row>
                                                <Col span={20}>
                                                    <Input placeholder='请输入' value={remark} onChange={(e) => { this.onUserRemarkChange(e, record, index) }} />
                                                </Col>
                                                <Col span={4}>
                                                    &nbsp;<Icon onClick={(e) => this.onEditRemarkWaitClick(e, record, index)} type='edit'></Icon>
                                                </Col>
                                            </Row>
                                            :
                                            <Row>
                ...
                {
                    title: '附件',
                    dataIndex: 'attachments', width: '60', align: 'center',
                    render: (attachments, record, index) => {
                        return (
                            <a onClick={(e) => this.onAttachmentClick(e, record, index)}>
                                <span>{attachments.length}</span>
                ...
                {
                    title: '复核状态',
                    dataIndex: 'statusDescription', align: 'center', width: '100'
                },
                {
                    title: '复核意见',
                    dataIndex: 'approvalOpinions', width: '150', align: 'center',
                ...
                {
                    title: '操作',
                    dataIndex: 'operation', width: '144', fixed: 'right', align: 'center',
                    render: (operation, record, index) => {
                        return (
                            <div>
                                <Popconfirm title='是否确认作废此次核销反冲？作废后仍可重新发起' okText='确认' cancelText='取消' onConfirm={(e) => this.onUserCancelClick(e, record)}>
                                    <a disabled={record.status !== 'N'} >作废</a>
                                </Popconfirm>
                                <Divider type='vertical' />
                                <Popconfirm title='是否确认重新发起此次核销反冲？' okText='确认' cancelText='取消' onConfirm={(e) => this.onUserReservedAgainClick(e, record, index)}>
            ...
            searchForm2: [
                { type: 'input', id: 'documentNumber', label: '报账单编号', colSpan: '6' },
                {
                    type: 'select', colSpan: '6', id: 'status', label: '复核状态',
                    options: [{ value: 'N', label: '驳回' }, { value: 'P', label: '复核中' }, { value: 'Y', label: '已复核' }]
                },
                { type: 'input', colSpan: '6', id: 'sourceDocumentNumber', label: '被核销单据编号' },
                { type: 'input', colSpan: '6', id: 'billCode', label: '付款流水号' },
                {
                ...
                { type: 'list', listExtraParams: { setOfBooksId: this.props.company.setOfBooksId }, colSpan: '6', id: 'applicantId', label: '申请人', listType: 'bgtUserOID', valueKey: 'id', labelKey: 'fullName', single: true },
                { type: 'list', colSpan: '6', id: 'approvalId', label: '复核人', listType: 'bgtUserOID', valueKey: 'id', labelKey: 'fullName', single: true },
    ...
    onAmountMouseMove = (e, record, index) => {
        ...
        data1[index].reversedAmount = this.filterMoney(record.reversedAmount, 2, true).replace(/,/g, "");
        this.setState({
            data1
        });
    }
    ...
    onReversedAmountMouseMove = (e, record, index) => {
        ...
        data2[index].reversedAmount = this.filterMoney(record.reversedAmount, 2, true).replace(/,/g, "");
        this.setState({
            data2
        });
    }
    ...
    onSourceDocumentNumberClick = (e, record, index) => {
        ...
        this.setState({
            modalTitle: '预付款单详情',
            modalVisible: true,
            modalContent: <PrePaymentCommonReadonly params={{ id: record.cashWriteOffReservePrepaymentRequisition.paymentRequisitionHeaderId, flag: 'prePayment' }} id={record.cashWriteOffReservePrepaymentRequisition.paymentRequisitionHeaderId} flag='prePayment'></PrePaymentCommonReadonly>
        });
    }
    /**
     * 附件
    ...
    onOperationClick = (e, record, index) => {
        ...
        if (!record.reversedAmount) {
            ...
            cshWriteOffBacklashService.cshWriteOffDoReserved(id, reversedAmount, remark, attachmentOid).then(res => {
                if (res.status === 200) {
    ...
    getWaitReserveDetail = () => {
        ...
        cshWriteOffBacklashService.getWriteOffWaitReserveDetail(params).then(res => {
            if (res.status === 200) {
                this.setState({
                    data1: res.data,
                    loading1: false,
    ...
    */
    ...
    getWriteOffUserReservedDetail = () => {
        ...
        cshWriteOffBacklashService.getWriteOffUserReservedDetail(params).then(res => {
            if (res.status === 200) {
                this.setState({
                    data2: res.data,
                    loading2: false,
    ...
    onUserCancelClick = (e, record) => {
        ...
        cshWriteOffBacklashService.cshWriteOffDoReservedCancel(record.id).then(res => {
            if (res.status === 200) {
    ...
    onUserReservedAgainClick = (e, record, index) => {
        ...
        if (!record.reversedAmount) {
            ...
            let attachmentOid = record.attachmentOid;
            cshWriteOffBacklashService.cshWriteOffDoReservedAgain(id, reversedAmount, remark, attachmentOid).then(res => {
                if (res.status === 200) {
                            ...
                            return (
                                <div>
                                    <Row gutter={24} type='flex' justify='start' style={{ marginLeft: '-9px', borderBottom: '1px solid #D0D0D0', paddingBottom: '8px' }}>
                                        ...
                                        <Col span={4} offset={1}>计划付款日期：{moment(record.cashWriteOffReserveExpReport.schedulePaymentDate).format('YYYY-MM-DD')}</Col>
                                        <Col span={4} className='over-range'>
                                    ...
                                    <Row gutter={24} type='flex' justify='start' style={{ paddingTop: '8px', marginLeft: '-9px' }}>
                                        ...
                                        <Col span={4} offset={1}>计划付款日期：{moment(record.cashWriteOffReservePrepaymentRequisition.requisitionPaymentDate).format('YYYY-MM-DD')}</Col>
                                        <Col span={4} className='over-range'>
