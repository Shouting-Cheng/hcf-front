...
class BudgetJournalCheckDetail extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      columns: [
        {
          /*公司*/
          title: this.$t('budgetJournal.companyId'), key: "companyName", dataIndex: 'companyName', width: '8%',
          render: companyName => (
        ...
        {
          /*部门*/
          title: this.$t('budgetJournal.unitId'), key: "departmentName", dataIndex: 'departmentName', width: '8%',
          render: unitName => (
        ...
        {          /*人员*/
          title: this.$t('budgetJournal.employeeId'), key: "employeeName", dataIndex: 'employeeName',
          render: recode => (
        ...
        {
          /*预算项目*/
          title: this.$t('budgetJournal.item'), key: "itemName", dataIndex: 'itemName', width: '16%',
          render: itemName => (
        ...
        {
          /*期间*/
          title: this.$t('budgetJournal.periodName'), key: "periodName", dataIndex: 'periodName', width: '6%',

        },
        {
          /*季度*/
          title: this.$t('budgetJournal.periodQuarter'), width: '6%',
          key: "periodQuarterName",
          dataIndex: 'periodQuarterName'
        },
        {
          /*年度*/
          title: this.$t('budgetJournal.periodYear'), key: "periodYear", dataIndex: 'periodYear', width: '8%'
        },
        {
          /*币种*/
          title: this.$t('budgetJournal.currency'), key: "currency", dataIndex: 'currency', width: '8%'
        },
        {
          /*汇率*/
          title: this.$t('budgetJournal.rate'), key: "rate", dataIndex: 'rate', width: '8%',
        },
        {
          /*金额*/
          title: this.$t('budgetJournal.amount'), key: "amount", dataIndex: 'amount',
          render: recode => (
        ...
        {
          /*数字*/
          title: this.$t('budgetJournal.quantity'), key: "quantity", dataIndex: 'quantity', with: '8%',
        },
        {
          /*备注*/
          title: this.$t('budgetJournal.remark'), key: "remark", dataIndex: 'remark',
          render: remark => (
  ...
  //获取日志记账头行
  getHeadLine(){
    budgetJournalService.getBudgetJournalHeaderLine(this.props.match.params.journalCode).then(resp=>{
      this.setState({
        loading: false,
  ...
  render() {
    const { data, columns, infoData, headerData, approvalTxt, passLoading, rejectLoading, } = this.state;
        ...
        <Spin spinning={this.state.spinLoading}>
          <div className="base-info">
            <div className="base-info-header">
              {this.$t('budgetJournal.basicInformation')}
            </div>
          ...
          {this.props.match.params.flag === "approved" ?
            (
              <Affix offsetBottom={0} className="bottom-bar">
                <Button className="button-return" style={{ marginLeft: '20px', marginRight: '8px' }} onClick={this.HandleReturn}>{this.$t('budgetJournal.return')}</Button>
              </Affix>
            )
            :
            (
...
export default connect(mapStateToProps, null, null, { withRef: true })(WebBudgetJournalCheckDetail);
