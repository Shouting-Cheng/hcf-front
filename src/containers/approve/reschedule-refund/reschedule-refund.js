...
class ApproveRescheduleRefund extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      columns: [
        ...
        {
          title: messages('request.detail.booker.type' /*类型*/),
          dataIndex: 'type',
          render: type =>
            type === 1002
              ? messages('check.center.reschedule' /*改签*/)
        ...
        {
          title: messages('price.review.reason' /*原因*/),
          dataIndex: 'isPersonalReasom',
          render: value =>
            value
              ? messages('request.detail.booker.person' /*个人*/)
              : messages('request.detail.booker.project' /*项目*/),
        },
      ],
      data: [],
      page: 0,
  ...
  getList = () => {
    ...
    approveRescheduleRefundService
      .getApproveRescheduleRefundtList(
        tab === 'approved',
        page,
        pageSize,
      ...
      <div className="approve-reschedule-refund">
        ...
        <div className="table-header">
          <div className="table-header-title">
            {messages(
              'common.total',
              { total: pagination.total } /*共搜索到 {pagination.total} 条数据*/
            )}
          </div>
        </div>
        <Table
...
export default connect(
  ...
  null,
  { withRef: true }
)(wrappedApproveRescheduleRefund);
