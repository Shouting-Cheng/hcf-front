        ...
        {this.props.params.visible && <Form onSubmit={this.handleSave}>
          <Spin spinning={loading}>
            <div style={{ paddingBottom: 50 }}>
              ...
              {this.state.shareParams.defaultApportion && <NewShare handleOk={this.getShareData} isRefresh={this.state.isRefreshShareTabel} edit={this.editShare} deleteShare={this.deleteShare} params={this.state.shareParams} data={applicationData}></NewShare>}
            </div>
