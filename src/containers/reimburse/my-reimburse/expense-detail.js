      ...
      <div className="new-expense">
        {this.props.params.visible && (
          <Form onSubmit={this.handleSave}>
                    ...
                    <div style={{ overflow: 'hidden' }} className="expense-type-container">
                      ...
                      {this.props.params.visible && (
                        <FormItem label="附件" labelCol={{ span: 3 }} wrapperCol={{ span: 20 }}>
                          {editModel.attachments &&
                            editModel.attachments.map((item, index) => {
                              return (
                                <div key={index}>
            ...
            >
                {
                  this.props.params.headerData.reportStatus===1002 ||
                  this.props.params.headerData.reportStatus===1004||
                  this.props.params.headerData.reportStatus===2002||
                  this.props.approve ||
                  this.props.params.headerData.status ===1002 ?
