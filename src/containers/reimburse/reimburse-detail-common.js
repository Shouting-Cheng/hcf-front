...
import { Form, Tabs, Button, Menu, Radio, Dropdown, Row, Col, Spin, Table, Timeline, message, Popover, Popconfirm, Icon, Select } from 'antd'
...
class ContractDetailCommon extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      contractStatus: {
        6002: { label: formatMessage({ id: "my.contract.state.cancel" }/*已取消*/), state: 'default' },
        6003: { label: formatMessage({ id: "my.contract.state.finish" }/*已完成*/), state: 'success' },
        1001: { label: formatMessage({ id: "my.contract.state.generate" }/*编辑中*/), state: 'processing' },
        6001: { label: formatMessage({ id: "my.contract.state.hold" }/*暂挂*/), state: 'warning' },
        1002: { label: formatMessage({ id: "my.contract.state.submitted" }/*审批中*/), state: 'processing' },
        1005: { label: formatMessage({ id: "my.contract.state.rejected" }/*已驳回*/), state: 'error' },
        1004: { label: formatMessage({ id: "my.contract.state.confirm" }/*已通过*/), state: 'success' },
        1003: { label: formatMessage({ id: "my.contract.state.withdrawal" }/*已撤回*/), state: 'warning' },
      ...
      columns: [
        ...
        { title: formatMessage({ id: "my.contract.plan.amount" }/*计划金额*/), dataIndex: 'amount', render: this.filterMoney },
        { title: formatMessage({ id: "my.contract.partner.category" }/*合同方类型*/), dataIndex: 'partnerCategoryName' },
        { title: formatMessage({ id: "my.contract.partner" }/*合同方*/), dataIndex: 'partnerName' },
        {
          title: formatMessage({ id: "my.contract.plan.pay.date" }/*计划付款日期*/), dataIndex: 'dueDate',
          render: value => moment(value).format('YYYY-MM-DD')
        },
        {
          title: formatMessage({ id: "common.remark" }/*备注*/), dataIndex: 'remark',
          render: value => {
            return (value ?
  ...
  render() {
    ...
    subContent.DETAIL = (
      <div>
        <div className="tab-container" style={{ marginBottom: 20 }}>
          <h3 style={{ padding: "0 0 10px", margin: 0 }} className="sub-header-title">费用信息</h3>
    ...
    return (
      <div className="contract-detail-common reimburse">
        <div className="top-info" style={{ padding: '24px 20px 20px 20px', backgroundColor: "#fff" }}>
          <Tabs forceRender defaultActiveKey="1" onChange={this.tabChange}>
            ...
            {this.props.headerData.reportStatus === 1006 && <TabPane tab="凭证信息" key="2">
