...
class BacklashRechecked  extends React.Component {
    ...
    this.state = {
      ...
      searchForm: [
        ...
        {type:'input',colSpan: 6, id:'refBillCode',label:this.$t({id: 'pay.backlash.sourceBacklashCode'})},
        {
          ...
          { type: 'date', colSpan: 6, id: 'backFlashDateFrom', label: this.$t({id: 'pay.backlash.backFlashDateFrom'})},
          { type: 'date', colSpan: 6, id: 'backFlashDateTo', label:  this.$t({id: 'pay.backlash.backFlashDateTo'}) }
        ]
        },
      ...
      columns: [
        ...
        {title: this.$t({id: 'pay.backlash.currency'}), dataIndex: 'currency',align: "center",width: 150},
  ...
  render(){
    const { goBacklash,openWindowFlag,loading1, searchForm, columns, canBacklashData,canBacklashPagination,pagination } = this.state;
    return(
