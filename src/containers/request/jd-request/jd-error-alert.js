...
class JDErrorAlert extends React.Component{
  ...
  componentWillReceiveProps(nextProps) {
    nextProps.info.jingDongOrderApplication && this.getRemainingTime(nextProps.info.jingDongOrderApplication.createdDate)
  }
...
export default connect(mapStateToProps, null, null, { withRef: true })(wrappedJDErrorAlert)
