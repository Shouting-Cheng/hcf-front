...
class NewLinkageSwitch extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.value.callBackSubmit != this.props.value.callBackSubmit || nextProps.value.callBackSubmit != callBackSubmit) {
  ...
  render() {
    ...
    return (
      <div className="new-linkage-switch">
        ...
        {enabled && fieldContent && fieldContent.map((item, index) => {
          let selectorItem = {
          ...
          switch (item.fieldType) {
            case 'TEXT':
              ...
              content = (
                <Input placeholder={item.promptInfo}
...
export default connect(mapStateToProps, null, null, { withRef: true })(wrappedNewLinkageSwitch)
