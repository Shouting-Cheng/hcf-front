...
import { isEmptyObj } from 'utils/extend';
...
class PersonManage extends React.Component {
  ...
  //     //  "员工信息";
  //     let name = this.$t("person.manage.person.info");
  //     FileSaver.saveAs(b, `${name}.xlsx`);
  //     this.setState({
  //       loading: false,
  //     })
  ...
  //     let b = new Blob([res.data], {type: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"});
  //     //  "证件信息";
  //     let name = this.$t("person.manage.card.info1");
  //     FileSaver.saveAs(b, `${name}.xlsx`);
  //   })
  //   .catch((res) => {
  //     this.setState({
  ...
  //       let b = new Blob([res.data], {type: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"});
  //       //  "银行卡信息";
  //       let name = this.$t("person.manage.bank.card.info");
  //       FileSaver.saveAs(b, `${name}.xlsx`);
  //     })
  //     .catch((res) => {
  //       this.setState({
  ...
  //       let b = new Blob([res.data], {type: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"});
  //       // "携程信息";
  //       let name = this.$t("person.manage.ctrip.info");
  //       FileSaver.saveAs(b, `${name}.xlsx`);
  //     })
  //     .catch((res) => {
  //       this.setState({
