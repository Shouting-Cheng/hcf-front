...
export default {
  ...
  downloadEmployeeTemplate: function() {
    return new Promise((resolve, reject) => {
      httpFetch
        .get(
          config.baseUrl + '/api/users/v2/fullInfo/template/export',
          {},
          {},
  ...
  downloadCtripSupplierTemplate: function() {
    return new Promise((resolve, reject) => {
      httpFetch
        .get(
          config.baseUrl + '/api/contact/supplier/ctrip/template/export',
          {},
          {},
          { responseType: 'arraybuffer' }
        )
  ...
  downloadBankAccountTemplate: function() {
    return new Promise((resolve, reject) => {
      httpFetch
        .get(
          config.baseUrl + '/api/contact/bank/accounts/template/export',
          {},
          {},
          { responseType: 'arraybuffer' }
        )
  ...
  downloadCardAccountTemplate: function() {
    return new Promise((resolve, reject) => {
      httpFetch
        .get(
          config.baseUrl + '/api/contact/cards/template/export',
          {},
          {},
          { responseType: 'arraybuffer' }
        )
