...
import {
  Button,Icon, Menu, Dropdown,message,Popover
} from 'antd';
...
class OrgStructureRoles extends React.Component {
  ...
  render() {
    ...
    if (this.state.editing) {
      rolesTitleWrap = <div className="f-left">
        ...
        <input className="f-left roles-title-text"
               key={'custDeptNumber'}
               onChange={this.depCustDeptNumberChange}
               value={this.state.selectedKeysDepDataByApi.custDeptNumber?this.state.selectedKeysDepDataByApi.custDeptNumber:""}
