    ...
    this.state = {
      ...
      tabsData: {
        AUTHORIZATION: {
          ...
          columns:
            [
              ...
              {
                title: messages('bank.account.state'), dataIndex: 'isEnabled', width: '16%', render(enabled) {
        ...
        APY_TYPE: {
          ...
          columns:
            [
              { title: messages('pay.way.type'), dataIndex: 'paymentMethodCategory', key: "paymentMethodCategory" },
              ...
              {
                title: messages('common.operation'), dataIndex: 'id', width: 150, render: (text, record) => (
                  <span>
                    <a onClick={(e) => this.handleEdit(e, record)}>{messages('common.edit')}</a>
  ...
  render() {
    ...
    return (
      <div>
        ...
        <SlideFrame title= {JSON.stringify(updateParams) == "{}"?messages('bank.account.addAuthorization'):messages('bank.account.editAuthorization')}
          show={showSlideFrame}
        ...
        <SlideFrame title= {JSON.stringify(updateParams) == "{}"?messages('bank.account.addPayWay'):messages('bank.account.editPayWay')}
