...
class BankAccountDetail extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      tabsData: {
        AUTHORIZATION: {
          url: `${config.baseUrl}/api/companyBankAuth/selectCompanyBankId?id=${
        ...
        APY_TYPE: {
          rowSelection: null,
          url: `${config.baseUrl}/api/comapnyBankPayment/getByBankAccountId?id=${
            this.props.params.companyBankId
          }`,
          columns: [
            {
  ...
  getCompanyBankByCompanyBankId(companyBankId) {
    httpFetch
      .get(`${config.baseUrl}/api/CompanyBank/selectById?companyBankId=${companyBankId}`)
      .then(response => {
  ...
  deleteItem = (e, record) => {
    httpFetch
      .delete(`${config.baseUrl}/api/comapnyBankPayment/deleteById?id=${record.id}`)
      .then(res => {
  ...
  updateHandleInfo = params => {
    ...
    httpFetch
      .post(
        `${config.baseUrl}/api/CompanyBank/insertOrUpdate`,
