...
export default {
  ...
  createLegalPerson(object) {
    ...
    // }
    return new Promise((resolve, reject) => {
      httpFetch.post(config.baseUrl + '/api/company/receipted/invoice', object)
        .then((res) => {
          resolve(res)
        })
        .catch((err) => {
  ...
  updateLegalPerson(object) {
    return new Promise((resolve, reject) => {
      httpFetch.put(config.baseUrl + '/api/company/receipted/invoice', object)
        .then((res) => {
          resolve(res)
        })
        .catch((err) => {
  ...
  getLegalPersonDetail(oid) {
    return new Promise((resolve, reject) => {
      httpFetch.get(config.baseUrl + '/api/company/receipted/invoices/users/' + oid)
        .then((res) => {
          resolve(res)
        })
        .catch((err) => {
  ...
  getLegalPersonCompanys(params) {
    ...
    // }
    return new Promise((resolve, reject) => {
      httpFetch.get(config.baseUrl + '/api/company/by/legalentity', params)
        .then((res) => {
          resolve(res)
        })
        .catch((err) => {
  ...
  importPersonsToLegalPerson(companyReceiptedOID, userOIDs) {
    return new Promise((resolve, reject) => {
      httpFetch.post(config.baseUrl + '/api/company/receipted/invoice/associate/' + companyReceiptedOID, userOIDs)
        .then((res) => {
          resolve(res)
        })
        .catch((err) => {
  ...
  movePersonsToLegalPerson(params) {
    ...
    // }
    return new Promise((resolve, reject) => {
      httpFetch.put(config.baseUrl + '/api/company/receipted/invoice/move',params)
        .then((res) => {
          resolve(res)
        })
        .catch((err) => {
  ...
  getLegalList(params) {
    return new Promise((resolve, reject) => {
      httpFetch.get(config.baseUrl + '/api/v2/my/company/receipted/invoices?isAll=true', params)
        .then((res) => {
          resolve(res)
        })
        .catch((err) => {
