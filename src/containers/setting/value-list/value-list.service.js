...
export default {
  ...
  getValueListList(page, size, searchParams) {
    let url = `${config.baseUrl}/api/custom/enumerations?page=${page}&size=${size}`;
  ...
  getValueListInfo(id) {
    return new Promise(function(resolve, reject) {
      httpFetch.get(config.baseUrl + '/api/custom/enumerations/' + id)
      .then(function(res) {
        resolve(res);
      })
      .catch(function(err) {
  ...
  getValue(id) {
    return new Promise(function(resolve, reject) {
      httpFetch.get(config.baseUrl + '/api/custom/enumerations/items/' + id)
      .then(function(res) {
        resolve(res);
      })
      .catch(function(err) {
  ...
  //根据值列表Oid获取值内容列表
  getValueList(page, size, id, keyWords) {
    let params = {
      page,
      size,
      keyword: keyWords,
    ...
    return new Promise(function(resolve, reject) {
      httpFetch.get(config.baseUrl + '/api/custom/enumerations/' + id + '/items', params)
      .then(function(res) {
        resolve(res);
      })
      .catch(function(err) {
  ...
  exportValues(params, id, isCustom) {
    //isCustom传false就是系统值列表
    let url = `${config.baseUrl}/api/custom/enumerations/items/export?id=${id}&isCustom=${isCustom === 'CUSTOM'}`;
  ...
  //批量启用／禁用值列表项
  batchUpdate(ids, enable) {
    return new Promise(function(resolve, reject) {
      httpFetch.post(config.baseUrl + `/api/custom/enumeration/items/batch/enable/or/disable?enable=${enable}`, ids)
      .then(function(res) {
        resolve(res);
      })
      .catch(function(err) {
