  ...
  handleSave = e => {
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        ...
        httpFetch
          .post(`${config.baseUrl}/api/DepartmentGroup/insertOrUpdate`, values)
          .then(response => {
            if (response) {
              ...
              this.props.dispatch(
                routerRedux.push({
                  pathname: `/admin-setting/department-group/department-group-detail/${
                    response.data.id
                  }`,
                })
              );
            ...
            <Col span={8} offset={1}>
              ...
              >
                {getFieldDecorator('description', {
                  ...
                  <LanguageInput
                    nameChange={this.handleDescriptionChange}
                    name={name}
