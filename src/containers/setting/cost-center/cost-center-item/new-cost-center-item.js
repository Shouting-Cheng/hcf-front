    ...
    renderEditingFiled_cust_list = (field) => {
        ...
        return (
            <Col span={8} className="cost-center-form-row">
                <FormItem
                    key={field.fieldOID}
                    label={field.fieldName && field.fieldName.length && field.fieldName.length > 0 ? field.fieldName : <span>&nbsp;</span>}
                    colon={true}>
                ...
                <Form onSubmit={this.handleSave} onChange={this.handleChange}>
                    <Row gutter={24} className="cost-center-form-row">
                        <Col span={8}>
                            {/*//成本中心项代码*/}
                            <FormItem
                                label={this.$t("new.cost.center.item.code")}
                                colon={true}>
                                {getFieldDecorator('code', {
                                    ...
                                    <Input disabled={(!!costCenterItemDetail.id && !!costCenterItemDetail.code) || !this.props.tenantMode}
                        ...
                        <Col span={8}>
                            {/*//序号*/}
                            <FormItem
                                label={this.$t("new.cost.center.item.index")}
                                colon={true}>
                                {getFieldDecorator('sequenceNumber', {
                                    ...
                                    <Input disabled={!this.props.tenantMode}
                                        placeholder={this.$t("common.please.enter")} />)
                                }
                            </FormItem>
                        ...
                        <Col span={8}>
                            <div className="main-select-dep-wrap">
                                ...
                                <div className={depClass}>
                                    ...
                                    <div className={this.state.extraMainDep.depClassName}
                        ...
                        <Col span={8}>
                            <div className="sec-select-dep-wrap">
                                ...
                                <div className={depClass}>
                                    ...
                                    <div className={this.state.extraSecDep.depClassName}
                                        onMouseLeave={this.onMouseLeaveDepTag}
                                        onMouseEnter={this.onMouseEnterDepTag}
                    ...
                    <Row gutter={24} className="cost-center-form-row">
                        ...
                        <Col span={8}>
                            {/*全员可见*/}
                            <FormItem
                                label={this.$t("new.cost.center.item.showall")}
                                colon={false}>
                                {getFieldDecorator("publicFlag", {
                                    ...
                                    (<Switch disabled={!this.props.tenantMode}
...
export default connect(mapStateToProps, null, null, { withRef: true })(WrappedNewCostCenterItem);
