...
class CompanyLevelDefine extends React.Component {
  constructor(props) {
    ...
    this.state = ({
      ...
      columns: [
        { title: this.$t("company.level.define.company.code")/*公司级别代码*/, key: 'companyLevelCode', dataIndex: 'companyLevelCode', align: "center" },
        { title: this.$t("person.group.desc")/*描述*/, key: 'description', dataIndex: 'description', align: "center" },
        {
          title: this.$t("common.column.status")/*状态*/, align: "center", key: 'enabled', dataIndex: 'enabled', render: enabled => (
