...
export default {
  ...
  getCountries(lang) {
    ...
    return new Promise(function(resolve, reject) {
      httpFetch
        .get(config.locationUrl + '/api/localization/query/country', params)
        .then(function(res) {
          resolve(res);
        })
        .catch(function(err) {
  ...
  getStates(params) {
    ...
    return new Promise(function(resolve, reject) {
      httpFetch
        .get(config.locationUrl + '/api/localization/query/state', params)
        .then(function(res) {
          resolve(res);
        })
        .catch(function(err) {
  ...
  getCities(params) {
    ...
    return new Promise(function(resolve, reject) {
      httpFetch
        .get(config.locationUrl + '/api/localization/query/city', params)
        .then(function(res) {
          resolve(res);
        })
        .catch(function(err) {
  ...
  getSystemBankList(param, ps) {
    ...
    return new Promise(function(resolve, reject) {
      httpFetch
        .get(config.baseUrl + '/api/bank/infos', param)
  ...
  getSelfBankList(params, ps) {
    ...
    return new Promise(function(resolve, reject) {
      httpFetch
        .post(
          config.baseUrl +
            '/api/bank/infos/custom/search?page=' +
            ps.page +
            '&size=' +
            ps.size +
            '&isAll=true',
  ...
  createSelfBank(params) {
    ...
    return new Promise(function(resolve, reject) {
      httpFetch
        .post(config.baseUrl + '/api/bank/infos/custom/create', params)
        .then(function(res) {
          resolve(res);
        })
        .catch(function(err) {
  ...
  updateSelfBank(params) {
    return new Promise(function(resolve, reject) {
      httpFetch
        .put(config.baseUrl + '/api/bank/infos/custom/modify', params)
        .then(function(res) {
          resolve(res);
        })
        .catch(function(err) {
  ...
  deleteSelfBank(id) {
    return new Promise(function(resolve, reject) {
      httpFetch
        .delete(config.baseUrl + '/api/bank/infos/custom/remove/' + id)
        .then(function(res) {
          resolve(res);
        })
        .catch(function(err) {
  ...
  importSelfBank: function(file) {
    return new Promise((resolve, reject) => {
      httpFetch
        .post(config.baseUrl + '/api/bank/infos/import/custom/bank/info', file)
        .then(res => {
          resolve(res);
        })
        .catch(err => {
  ...
  importSelfBankErr: function(transactionOID) {
    return new Promise((resolve, reject) => {
      httpFetch
        .get(config.baseUrl + '/api/batch/transaction/logs/bank/info/' + transactionOID)
        .then(res => {
          resolve(res);
        })
        .catch(err => {
  ...
  exportSelfBankErr: function(transactionOID) {
    return new Promise((resolve, reject) => {
      httpFetch
        .get(
          config.baseUrl + '/api/batch/transaction/logs/failed/export/bankinfo/' + transactionOID,
          {},
          {},
  ...
  exportSelfBank: function() {
    return new Promise((resolve, reject) => {
      httpFetch
        .get(
          config.baseUrl + '/api/bank/infos/export/custom/bank/info',
          {},
          {},
          { responseType: 'arraybuffer' }
        )
  ...
  downloadSelfBankTemp: function() {
    return new Promise((resolve, reject) => {
      httpFetch
        .get(
          config.baseUrl + '/api/bank/infos/custom/bank/info/template',
          {},
          {},
          { responseType: 'arraybuffer' }
        )
