...
export default {
  ...
  getCountries(lang) {
    ...
    return new Promise(function(resolve, reject) {
      httpFetch
        .get(config.localUrl + '/api/localization/query/country', params)
        .then(function(res) {
          resolve(res);
        })
        .catch(function(err) {
  ...
  getStates(params) {
    ...
    return new Promise(function(resolve, reject) {
      httpFetch
        .get(config.localUrl + '/api/localization/query/state', params)
        .then(function(res) {
          resolve(res);
        })
        .catch(function(err) {
  ...
  getCities(params) {
    ...
    return new Promise(function(resolve, reject) {
      httpFetch
        .get(config.localUrl + '/api/localization/query/city', params)
        .then(function(res) {
          resolve(res);
        })
        .catch(function(err) {
