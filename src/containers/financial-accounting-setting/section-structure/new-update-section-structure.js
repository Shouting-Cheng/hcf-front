    ...
    return (
      <div className="new-update-section-structure">
        <Form onSubmit={this.handleSubmit}>
          ...
          <FormItem
            {...formItemLayout}
            label={this.$t({ id: 'section.structure.code' }) /*科目段结构代码*/}
          >
          ...
          <FormItem
            {...formItemLayout}
            label={this.$t({ id: 'section.structure.name' }) /*科目段结构名称*/}
          >
...
export default connect(
  ...
  null,
  { withRef: true }
)(WrappedNewUpdateSectionStructure);
