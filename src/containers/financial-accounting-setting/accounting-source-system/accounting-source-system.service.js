...
export default {
   ...
   * }
   * */
  getSystemSourceLineModelJudgeRules(params){
    return httpFetch.get(`${config.accountingUrl}/api/general/ledger/journal/line/model/system/judge/rules/query`, params)
  ...
  addSystemSourceLineModelJudgeRules(params){
    return httpFetch.post(`${config.accountingUrl}/api/general/ledger/journal/line/model/system/judge/rules`, params)
  },
  ...
  upSystemSourceLineModelJudgeRules(params){
    return httpFetch.put(`${config.accountingUrl}/api/general/ledger/journal/line/model/system/judge/rules`, params)
  },
   ...
   * }
   * */
  getSystemSourceLineModelDataRules(params){
    return httpFetch.get(`${config.accountingUrl}/api/general/ledger/journal/line/model/system/data/rules/query`, params)
   ...
   * 根据id查询凭证模板取值规则(系统级)
   * */
  getSystemSourceLineModelDataRulesById(id){
    return httpFetch.get(`${config.accountingUrl}/api/general/ledger/journal/line/model/system/data/rules/${id}`)
  },

  /**
   * 查询转换规则(系统级)
   * @param params={
       "modelSystemDataRuleId":1
	    "size":1,
	    "page":
   * }
   * */
  getSystemSourceLineModelChangeRules(params){
    return httpFetch.get(`${config.accountingUrl}/api/general/ledger/journal/line/model/system/change/rules/query?`, params)
   ...
   * }
   * */
  getSystemSourceLineModelRules(params){
    return httpFetch.get(`${config.accountingUrl}/api/general/ledger/system/transaction/account/rules/query`, params)
  },
  ...
  addSystemSourceLineModelRules(params){
    return httpFetch.post(`${config.accountingUrl}/api/general/ledger/system/transaction/account/rules`, params)
  },
  ...
  upSystemSourceLineModelRules(params){
    return httpFetch.put(`${config.accountingUrl}/api/general/ledger/system/transaction/account/rules`, params)
  },
  ...
  addSystemSourceLineModelChangeRules(params){
    return httpFetch.post(`${config.accountingUrl}/api/general/ledger/journal/line/model/system/change/rules`, params)
  },

  /**
   * 修改转换规则(系统级)
   * @param params={}* */
  upSystemSourceLineModelChangRules(params){
    return httpFetch.put(`${config.accountingUrl}/api/general/ledger/journal/line/model/system/change/rules`, params)
  },
  ...
  addSystemSourceLineModelDataRules(params){
    return httpFetch.post(`${config.accountingUrl}/api/general/ledger/journal/line/model/system/data/rules`, params)
  },
  ...
  upSystemSourceLineModelDataRules(params){
    return httpFetch.put(`${config.accountingUrl}/api/general/ledger/journal/line/model/system/data/rules`, params)
  },
