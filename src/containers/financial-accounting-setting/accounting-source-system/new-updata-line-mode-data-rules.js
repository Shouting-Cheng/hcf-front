...
class NewUpDataLineModeDataRulesSystem extends React.Component {
  ...
  //获取转换规则
  getChangeRules = (modelSystemDataRuleId) => {
    this.setState({
      spinningLoading: true,
    })
    let params = {};
    params.modelSystemDataRuleId = modelSystemDataRuleId;
    accountingService.getSystemSourceLineModelChangeRules(params).then((response) => {
      this.setState({
...
export default connect(mapStateToProps, null, null, { withRef: true })(NewUpDataLineModeDataRulesSystem);
