          ...
          if (record.dataRule != 'FIXED_VALUE' && record.dataRule != 'VALUE_OF_API') {
            return (
              <div style={{ whiteSpace: 'normal' }}>
                <div>
                  {`${this.$t({ id: 'accounting.source.sourceDataCode' })} : ` +
                    record.sourceDataName +
                    ' , ' +
                    `${this.$t({ id: 'accounting.source.sourceDatafile' })} : ` +
            ...
            return (
              <div style={{ whiteSpace: 'normal' }}>
                <div>
                  {record.dataRule != 'FIXED_VALUE'
                    ? `${this.$t({ id: 'accounting.source.fromAPI' })} : ` + record.tableField
                    : record.tableField}
                </div>
              </div>
            );
