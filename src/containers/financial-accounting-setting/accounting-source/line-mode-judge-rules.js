...
class LineModeJudgeRules extends React.Component {
  ...
  getList(searchText) {
    ...
    accountingService.getSourceLineModelJudgeRules(params).then((response) => {
...
LineModeJudgeRules.contextTypes = {
...
export default connect(mapStateToProps, null, null, { withRef: true })(LineModeJudgeRules);
