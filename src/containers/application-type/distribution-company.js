...
class CompanyDistribution extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      columns: [
        ...
        {
          title: '公司类型', dataIndex: 'companyTypeName', align: 'center',
      ...
      selectorItem: {
        title: "批量分配公司",
        url: `${config.expenseUrl}/api/expense/application/type/${props.match.params.id}/company/query/filter`,
        searchForm: [
  ...
  handleBack = () => {
    ...
    this.props.dispatch(routerRedux.push({
      pathname: "/document-type-manage/application-type/" + this.state.companyTypeInfo.setOfBooksId
    }));
