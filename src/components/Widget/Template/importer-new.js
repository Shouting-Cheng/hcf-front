...
//数据导入组件
class ImporterNew extends React.Component {
  constructor(props) {
    super(props);
...
ImporterNew.propTypes = {
  visible: PropTypes.bool,           //导入弹框是否可见
  templateUrl: PropTypes.string,    //模版下载接口
  uploadUrl: PropTypes.string,     //上传接口
  errorUrl: PropTypes.string,    //错误信息下载接口，不需要写transactionID变量 后台url http://*****/{transactionID} 此处写http://*****
...
export default connect(mapStateToProps, null, null, { withRef: true })(ImporterNew);
