...
class Chooser extends React.Component {
  ...
  render() {
    ...
    const { placeholder, disabled, selectorItem, type, listExtraParams, single,
      showNumber, newline, maxNum, labelKey, showClear, showArrow, showDetail, valueKey } = this.props;
    return (
